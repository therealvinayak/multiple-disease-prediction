...
if (selected == 'Diabetes Prediction'):
    ...
    if st.button('Diabetes Test Result'):
        diab_input = [float(Pregnancies), float(Glucose), float(BloodPressure), float(SkinThickness),
              float(Insulin), float(BMI), float(DiabetesPedigreeFunction), float(Age)]
        diab_prediction = diabetes_model.predict([diab_input])
...
if (selected == 'Heart Disease Prediction'):
    ...
    if st.button('Heart Disease Test Result'):
        heart_input = [float(age), float(sex), float(cp), float(trestbps), float(chol), float(fbs),
...
if (selected == "Parkinsons Prediction"):
    ...
    if st.button("Parkinson's Test Result"):
        parkinsons_input = [float(fo), float(fhi), float(flo), float(Jitter_percent), float(Jitter_Abs), float(RAP),
